# This Makefile is for the Template::Plugin::HTML::Menu extension to perl.
#
...
#     ABSTRACT_FROM => q[Menu.pm]
#     AUTHOR => q[Dave Cross <dave@mag-sol.demon.co.uk>]
#     NAME => q[Template::Plugin::HTML::Menu]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[Menu.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Template::Plugin::HTML::Menu
NAME_SYM = Template_Plugin_HTML_Menu
VERSION = 0.01
...
INSTALLARCHLIB = /usr/lib/perl5/5.8.6/i386-linux-thread-multi
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /usr/lib/perl5/site_perl/5.8.6/i386-linux-thread-multi
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = /usr/lib/perl5/vendor_perl/5.8.6/i386-linux-thread-multi
...
FULLEXT = Template/Plugin/HTML/Menu
BASEEXT = Menu
PARENT_NAME = Template::Plugin::HTML
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Template/Plugin/HTML
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Template/Plugin/HTML
...
PM_TO_BLIB = Menu.pm \
	$(INST_LIB)/Template/Plugin/HTML/Menu.pm
...
DISTNAME = Template-Plugin-HTML-Menu
DISTVNAME = Template-Plugin-HTML-Menu-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Menu.pm $(INST_MAN3DIR)/Template::Plugin::HTML::Menu.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Template-Plugin-HTML-Menu' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: Menu.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Dave Cross &lt;dave@mag-sol.demon.co.uk&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  Menu.pm $(INST_LIB)/Template/Plugin/HTML/Menu.pm 
